...
<p align="center">
  <img src="./assets/header.svg" alt="From hardware to intelligent systems. Embedded, trading, AI tooling and infrastructure." width="100%" />
</p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Firmware and hardware-facing software in <strong>C, C++ and Python</strong>, with an emphasis on clear interfaces, predictable behaviour, testing and system integration.</p>
    </td>
    <td width="50%" valign="top">
      <h3>02 &nbsp; AI tooling &amp; automation</h3>
      <p>Coding-agent workflows, reusable tooling and development automation. I work with scoped tasks, isolated workspaces, automated checks, independent reviews and human approval for consequential changes.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>03 &nbsp; Algorithmic trading</h3>
      <p>Event-driven trading systems spanning market data, market-regime analysis, backtesting, strategy optimisation, risk controls and execution monitoring.</p>
    </td>
    <td width="50%" valign="top">
      <h3>04 &nbsp; Software &amp; integration</h3>
      <p>Backend services, APIs, web applications and operational dashboards. I connect application logic, data and user interfaces into modular, maintainable systems.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>05 &nbsp; Infrastructure &amp; delivery</h3>
      <p>Linux environments, containers, self-hosted CI runners and deployment pipelines—with attention to reproducibility, monitoring, security and reliable day-to-day operation.</p>
    </td>
    <td width="50%" valign="top">
      <h3>06 &nbsp; Hardware &amp; compute</h3>
      <p>Workstation and server planning, component selection and system integration. I consider compatibility, workloads, resource limits and the trade-off between local and cloud compute.</p>
    </td>
  </tr>
</table>
...
<details>
  <summary><strong>Languages, platforms and tools I work with</strong></summary>
...
<p align="center">
  <strong>Good engineering connects the pieces—and makes the result understandable.</strong><br /><br />
  I welcome conversations about systems engineering, trading technology and practical AI automation.<br />
